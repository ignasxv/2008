...
The script then stages all the files `git add .` and commits it, using the date `{YEAR}-01-01T18:00:00` (`line 16`) or `6pm, 1st January, 2008` (default of the `YEAR` variable)
...
GitHub recognizes the commit to have been created at `6 pm, 1st January, 2008` and thus registers a contribution at that moment in time. If you scroll to the first year on your profile, you will see there is a single contribution to your `2008` repository, on 1st January.
